...
<head>
    ...
    <script src='js/book-appoitment-calendar.js' defer></script>
    ...
    <div class='container' id='desk-top-calendar' styles='margin-top:50px'>
            ...
            <div style='border: 2px solid <?= $accent_color; ?>' class='calendar'>
                <div class='month'>
                    ...
                    <div style='display:flex; flex-direction:column; align-items:center'>
                        <h3 style='margin:25px 0 10px; color:<?= $accent_color; ?>'>Your Barbershop</h3>
                        <div class='date'></div>
                    </div>
                ...
                <div class='goto-today'>
                    ...
                    <button style='border:1px solid <?= $accent_color; ?>; color:<?= $accent_color; ?>' class='today-btn'>today</button>
                </div>
            </div>
        </div>
        ...
        <div class='right'>
            ...
            <form style='display:flex; flex-direction: column; position:relative' id='calendar-form'
                ...
                <p id='select-service-desk-top' class='medium-font mt-10 mb-10'><span style='color:<?= $accent_color; ?>'>1.</span> Select Services</p>
                ...
                <div
                    ...
                    <div style='margin-bottom: 20px'>
                        ...
                        <input style='font-size:15px;' type='hidden' name='service_time'
                            value='<?=$service_chosen['service_time'] ?>' readonly>| <?=$service_chosen['service_time'] ?> min
                ...
                <div class='today-date'>
                    <p style='margin-top: 20px' id='select-a-date-desk-top' class='medium-font'><span style='color:<?= $accent_color; ?>'>2.</span> Select Date</p>
                    ...
                    <div style='display:flex; flex-direction:column; margin-bottom: 20px'>
                        <span class='medium-font' id='pick-time'><span style='color:<?= $accent_color; ?>'>3.</span> Select Time</span>
                    ...
                    <span class='medium-font' style='color:<?= $accent_color; ?>'>4. </span>
                ...
                <div id='display-form-contents-div' style='margin-top:250px;'>
                    <div>
                        <p class='medium-font' style='margin-bottom: 20px; '><span style='color:<?= $accent_color; ?>'>5.</span> <span style='color:#333'>Contact Information</span></p>
                    </div>
                    ...
                    <input style='margin-bottom:10px;' type="text" name='name' id='name' placeholder='John Smith'
                        required>
                    ...
                    <input style='margin-bottom:10px;' type="text" name='phone' id='phone' placeholder='555-555-5555'
                        required>
                    <br>
                    <label style='display:inline-block; width: 70px' for='email'>Email</label>
                    <input style='margin-bottom:10px;' type="email" name='email' id='email'
                    ...
                    <button style='width: 90px; margin-top: 10px; color:<?= $secondary_color ?>; border: 1px solid <?= $accent_color; ?>; background:<?= $accent_color; ?>' type='submit' name='submit_appointment'
